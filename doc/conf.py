...
latex_documents = [
    (
        master_doc,
        "PennyLane-Qiskit.tex",
        "PennyLane-Qiskit Documentation",
        "Carsten Blank, Xanadu Inc.",
        "manual",
    ),
]
...
man_pages = [(master_doc, "pennylane-qiskit", "PennyLane-Qiskit Documentation", [author], 1)]
...
texinfo_documents = [
    (
        ...
        author,
        "PennyLane-Qiskit",
        "PennyLane Quantum Machine Learning Plugin.",
        "Miscellaneous",
    ),
]
...
from directives import CustomDemoGalleryItemDirective
